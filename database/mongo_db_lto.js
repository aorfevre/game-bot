...
module.exports.init = function() {
  ...
  return new Promise(function(resolve, reject) {
    var url = "ablock:5L3gXqPkLrwRrgVyvJqN7jJdA@localhost:27017/LTOWalletBot?authSource=admin";

    if (isDev)
      url = "ablock:5L3gXqPkLrwRrgVyvJqN7jJdA@3.12.222.35:27017/LTOWalletBot?authSource=admin";



    _mdblto = mongojs(url, ['users', "airdrop", "metrics"])

    //
    // _mdblto["users_participating_1"].getIndexes(function(r){

    //   if(r===null){
    //     _mdblto["users_participating_1"].createIndex({ airdrop_status: true })
...
module.exports.get = function(query, key) {
  ...
  return new Promise(function(resolve, reject) {
    _this.init().then(function() {
      ...
      _mdblto[query].find(_query).toArray(function(err, items) {
        if (err) {
          reject(err);
        } else {
...
module.exports.find = function(collection, query, fields, count) {
  ...
  return new Promise(function(resolve, reject) {
    _this.init().then(function() {
      ...
      if (count) {
        _mdblto[collection].find(query, fields).count(function(e, count) {
        ...
        // console.log("FIND ",query,key,_query)
        _mdblto[collection].find(query, fields, function(err, items) {
...
module.exports.countUsers = function(query) {
  ...
  return new Promise(function(resolve, reject) {
    _this.init().then(function() {
      ...
      _mdblto[query].count(function(e, count) {
